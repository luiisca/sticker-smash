...
export default function App() {
  ...
  const onSaveImageAsync = async () => {
    try {
      ...
      if (screenshootUri) {
        Alert.alert("Saved!", "Your image has been saved to your photos.", [
          { text: "OK", style: "cancel" },
        ]);
      }
    } catch (e) {
      Alert.alert("Error!", "Something went wrong while saving your image.", [
        { text: "OK", style: "cancel" },
      ]);
    }
  };
  ...
  return (
    <GestureHandlerRootView style={styles.container}>
      ...
      <EmojiPicker
        ...
        onClose={onCloseEmojiPickerModal}
      >
        <EmojiList
          closeModal={onCloseEmojiPickerModal}
